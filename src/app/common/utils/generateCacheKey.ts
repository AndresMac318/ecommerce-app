import { ProductFilters, ProductPagination } from "../../features/products/+state/product.state";
...
export const generateCacheKey = (pagination: ProductPagination, filters: ProductFilters) => {
...
export const parseCacheKey = (cacheKey: string): cacheKeys => {
    ...
    return ({
        ...
        filters: {
            ...
            priceRange: [Number.parseInt(propertiesArr[3]), Number.parseInt(propertiesArr[4])]
        }
    }) 
}